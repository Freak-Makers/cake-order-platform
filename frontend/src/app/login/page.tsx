  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-zinc-50 px-4">
      <div className="w-full max-w-md overflow-hidden rounded-2xl bg-white shadow-xl shadow-zinc-200/50">
        {/* Header */}
        <div className="relative bg-white p-8 pb-4 text-center">
          <Link 
            href="/" 
            className="absolute left-6 top-8 flex items-center gap-1 text-sm font-medium text-zinc-400 transition-colors hover:text-zinc-600"
          >
            <ChevronLeft size={18} />
            홈으로
          </Link>
          ...
          <p className="mt-2 text-zinc-500">원하시는 체험 모드를 선택해주세요.</p>
        </div>
